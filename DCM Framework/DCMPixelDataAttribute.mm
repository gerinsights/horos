...
- (NSData *)convertJPEGLSToHost:(NSData *)jpegLsData
{
    ...
    // TODO(Sprint 7): migrate to charls_jpegls_decoder C API (JpegLsReadHeader/JpegLsDecode
    // are deprecated in CharLS 2.x but still present; full migration deferred to DCM Framework sprint)

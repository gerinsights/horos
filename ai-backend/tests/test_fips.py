...
These tests verify that the OpenSSL FIPS provider is properly configured
and that non-FIPS algorithms are blocked.
"""
...
def test_certificate_algorithm():
    """Verify generate_certs.sh would produce FIPS-compliant certs.

    Checks that openssl supports ECDSA P-384 + SHA-384.
    """
